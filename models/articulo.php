...
Class Articulo
{
	...
	{
		$sql="SELECT art.idarticulo, art.idcategoria, cat.nombre as categoria, art.codigo,
         art.nombre, art.stock, art.descripcion, art.imagen, art.condicion FROM articulo art 
         INNER JOIN categoria cat ON art.idcategoria=cat.idcategoria";
		return ejecutarConsulta($sql);		
	}
	...
	{
		$sql="SELECT a.idarticulo,a.idcategoria,c.nombre as categoria,
		a.codigo,a.nombre,a.stock,(SELECT precio_venta FROM detalle_ingreso 
		WHERE idarticulo=a.idarticulo order by iddetalle_ingreso desc limit 0,1) 
